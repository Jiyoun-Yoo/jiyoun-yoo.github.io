...
## 컴퓨터개론 1장 6절: 미래 컴퓨팅 기술

### **1. 클라우드 컴퓨팅**
- **클라우드 컴퓨팅(Cloud Computing)** : 인터넷 서버를 통해 데이터 저장, 네트워크, 콘텐츠 사용 등 ICT 기술 관련 서비스를 동시에 사용 가능케 하는 컴퓨팅 환경
...
### **2. 사물 인터넷**
- **사물 인터넷(IoT, Internet of Things)** : 각종 사물에 컴퓨터칩과 통신 기능을 내장해 인터넷에 연결하는 기술
