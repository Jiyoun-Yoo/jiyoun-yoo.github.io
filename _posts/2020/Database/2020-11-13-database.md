...
![DB모델링 유니크 컬럼 지정]({{ https://jiyounyou.github.io/ }}{{ site.baseurl }}/assets/images/post/database/dbmodeling-09.png){: .align-center}{: width="100%" height="100%"}
...
![DB모델링 인덱스 컬럼 지정 방법]({{ https://jiyounyou.github.io/ }}{{ site.baseurl }}/assets/images/post/database/dbmodeling-11-1.png){: .align-center}{: width="100%" height="100%"}
...
![DB모델링 도메인 정의 및 적용]({{ https://jiyounyou.github.io/ }}{{ site.baseurl }}/assets/images/post/database/dbmodeling-22.png){: .align-center}{: width="100%" height="100%"}
